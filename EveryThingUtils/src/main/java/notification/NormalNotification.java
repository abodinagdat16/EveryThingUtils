...
public class NormalNotification {
	...
	public NormalNotification(Context c, String name, String description, int id) {
	...
	public NormalNotification(Context c, String name, String description, int id, int importance) {
	...
	public NormalNotification(Context c, String name, String description, int id, Uri u) {
	...
	public NormalNotification(Context c, String name, String description, int id, int importance, Uri u) {
