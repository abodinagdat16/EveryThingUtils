...
public class BigNotification {
	...
	public Notification.BigTextStyle nbts;

	public BigNotification(Context c, String name, String description, int id) {
		...
		nbts = new Notification.BigTextStyle();

	}

	public BigNotification(Context c, String name, String description, int id, int importance) {
	...
	public BigNotification(Context c, String name, String description, int id, Uri u) {
	...
	public BigNotification(Context c, String name, String description, int id, int importance, Uri u) {
	...
	public void setBigText(String descr) {
	...
	public void show() {
		...
		nm.notify(noti_id, n.setStyle(nbts).build());

	}

	public Notification getNotification() {

		return n.setStyle(nbts).build();
