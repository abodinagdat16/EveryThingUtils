...
- title , by you
- العنوان ، بواسطتك
- big image title , by you
- عنوان الصورة الكبيرة ، بواسطتك
- description , by you
- الوصف ، بواسطتك
- small icon , by you
...
MyNotification = new BigImageNotification(YourContext , YourChannelName , YourSystemDescription , (int)YourNotificationIdNumber , android.app.NotificationManager.IMPORTANCE_DEFAULT , NotificationSound);
...
MyNotification = new BigImageNotification(YourContext , YourChannelName , YourSystemDescription , (int)YourNotificationIdNumber , android.app.NotificationManager.IMPORTANCE_DEFAULT , new NotificationSound(YourContext).setSound(Uri.parse("url رابط")).getUri());
...
## how to set Big Image Title ? كيفية تعيين عنوان الصورة الكبيرة
...
** عنوان الصورة الكبيرة ، متغير او قيمة نصية**
...
## NOW WE WILL TALK ABOUT BIG IMAGE , same as previous but setBigImage instead of setBigIcon

## الآن سوف نتحدث عن الأيقونة الكبيرة

**نفس السابقة و لكن استبدل**
